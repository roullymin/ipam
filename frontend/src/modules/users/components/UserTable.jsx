        ...
        <table className="w-full border-collapse text-left text-sm text-slate-600">
          <thead className="border-b border-slate-200 bg-slate-50 text-xs text-slate-500">
            <tr>
              ...
              <th className="px-4 py-3 font-semibold">显示名 / 部门</th>
              <th className="px-4 py-3 font-semibold">系统角色</th>
              <th className="px-4 py-3 font-semibold">权限范围</th>
              <th className="px-4 py-3 font-semibold">密码策略</th>
              <th className="px-4 py-3 font-semibold">登录安全</th>
              <th className="px-4 py-3 font-semibold">上次登录</th>
            ...
            {users.map((user) => {
              ...
              return (
                <tr key={user.id} className="transition-colors hover:bg-slate-50/70">
                  ...
                  <td className="px-4 py-3 text-xs text-slate-400">{formatTime(user.last_login)}</td>
                  <td className="px-4 py-3">
                    <StatusBadge
